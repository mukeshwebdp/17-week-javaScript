### 1. Write a function called "addNumbers" that take two numners as arguments and returns their sum. Call the functon before before it is declared to demonstrate hoisting.
